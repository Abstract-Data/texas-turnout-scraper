...
def test_infer_primary_runoff():
    assert infer_election_type("2026 REPUBLICAN PRIMARY RUNOFF ELECTION") == ElectionType.PRIMARY_RUNOFF
...
def test_infer_constitutional():
    assert infer_election_type("2025 NOVEMBER 4TH CONSTITUTIONAL AMENDMENT") == ElectionType.CONSTITUTIONAL_AMENDMENT
